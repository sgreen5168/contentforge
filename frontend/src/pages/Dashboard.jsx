...
const TOPICS = [
  ...
  { id:'burr-grinder', cat:'coffee', label:'Why Cheap Coffee Tastes Bitter', icon:'☕',
    hook:"The real reason home coffee never tastes as good as the coffee shop — and the $40 fix.",
  ...
  { id:'home-latte', cat:'coffee', label:'Café Latte at Home for Under $1', icon:'☕',
    hook:"Spending $7 a day on lattes adds up to $2500 a year. Here is the two-minute fix.",
  ...
  { id:'coffee-roasts', cat:'coffee', label:'Dark Roast Has Less Caffeine', icon:'☕',
    hook:"Most people drink dark roast thinking it is stronger. The science says the opposite.",
      ...
      <div style={{ marginBottom:12, padding:'10px 14px', background:'rgba(255,255,255,.03)', border:`1px solid ${BORD}`, borderRadius:10, display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:8 }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', alignItems:'center' }}>
          {[
            ...
            { label:'Facebook', ok:fbTokenStatus?.status==='valid' },
          ].map(function(s,i){
            return (
